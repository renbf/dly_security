...
public class ShiroConfig {
    ...
    public EhCacheManager getEhCacheManager() {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("dly");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/dly.png**", "anon");
...
//        filterChainDefinitionMap.put("/module/**","anon");
        ...
        filterChainDefinitionMap.put("/safety/accountNumber/**","anon");
        // 系统权限列表
