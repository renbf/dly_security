...
public class TRiskLevelControlController extends BaseController
{
	...
	@PostMapping("/add")
	@ResponseBody
	public AjaxResult addSave(TRiskLevelControl tRiskLevelControl)
	{		
		return toAjax(tRiskLevelControlService.insertTRiskLevelControl(tRiskLevelControl));
	}
	...
	@PostMapping("/edit")
	@ResponseBody
	public AjaxResult editSave(TRiskLevelControl tRiskLevelControl)
	{		
		return toAjax(tRiskLevelControlService.updateTRiskLevelControl(tRiskLevelControl));
	}
