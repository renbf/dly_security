...
public class TCarRepairController extends BaseController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(TCarRepair tCarRepair, MultipartFile file) {
        return tCarRepairService.insertTCarRepair(tCarRepair,file);
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(TCarRepair tCarRepair,MultipartFile file) {
        return tCarRepairService.updateTCarRepair(tCarRepair,file);
    }
