...
public class TCarTestingEvaluateController extends BaseController
{
	...
	@PostMapping("/add")
	@ResponseBody
	public AjaxResult addSave(TCarTestingEvaluate tCarTestingEvaluate)
	{		
		return toAjax(tCarTestingEvaluateService.insertTCarTestingEvaluate(tCarTestingEvaluate));
	}
	...
	@PostMapping("/edit")
	@ResponseBody
	public AjaxResult editSave(TCarTestingEvaluate tCarTestingEvaluate)
	{		
		return toAjax(tCarTestingEvaluateService.updateTCarTestingEvaluate(tCarTestingEvaluate));
	}
