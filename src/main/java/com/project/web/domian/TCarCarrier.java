...
/**
 * 承运人责任险表 t_car_carrier
 *
 * @author rbf
 * @date 2019-04-23
 */
public class TCarCarrier extends BaseEntity {
    ...
    public TCarCarrier setValidityDate1(Date validityDate1) {
    ...
    public TCarCarrier setValidityDateStr(String validityDateStr) {
    ...
    public TCarCarrier setCreateDateStr(String createDateStr) {
