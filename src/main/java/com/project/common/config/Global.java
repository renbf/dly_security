...
public class Global {
    ...
    public static String getName() {
        return StringUtils.nvl(getConfig("project.name"), "dly");
    }
    ...
    public static String getAuthor() {
        return StringUtils.nvl(getConfig("gen.author"), "dly");
    }
    ...
    public static String getPackageName() {
        return StringUtils.nvl(getConfig("gen.packageName"), "com.project.gift");
    }
